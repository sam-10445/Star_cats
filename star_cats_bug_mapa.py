...
while True:
    ...
    if tela_mapa:
        ...
        janela.blit(titulo, (725, 130))
        if tarefa == 1:
            janela.blit(tarefa1, (725, 160))
            janela.blit(tarefa1_1, (725, 180))
        elif tarefa == 2:
            janela.blit(tarefa2, (725, 160))
        elif tarefa == 3:
            janela.blit(tarefa3, (725, 160))
        elif tarefa == 4:
            janela.blit(tarefa4, (725, 160))
            janela.blit(tarefa4_1, (725, 180))
